...
model IEEE14_SinglePh_B02
  extends Modelica.Icons.Example;
    ...
    PaperRepository.Loads.LoadVar Load02(P_0=lambda*21.7,
      Q_0=lambda*12.7,
      V_0=0.956771,
      angle_0=-10.2391,
      dP=3.038,
      dQ=1.778)                                                                                                                  annotation (
      Placement(visible = true, transformation(origin={96,-72},    extent = {{-10, -10}, {10, 10}}, rotation = 90)));
    OpenIPSL.Electrical.Branches.PwLine R650_632(B = 0, G = 0,
      R=0.01938,
      X=0.05917)                                                                         annotation (
      Placement(visible = true, transformation(origin={32,-72},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenIPSL.Electrical.Buses.Bus B632 annotation (
      Placement(visible = true, transformation(origin={62,-72},    extent = {{-15, -15}, {15, 15}}, rotation = 0)));
    OpenIPSL.Electrical.Buses.Bus B650 annotation (
      Placement(visible = true, transformation(origin={4,-72},     extent = {{-15, -15}, {15, 15}}, rotation = 0)));
    OpenIPSL.Electrical.Branches.PSAT.TwoWindingTransformer twoWindingTransformer1(r=0, x=0.11001)  annotation (
...
equation
    connect(twoWindingTransformer1.n, B650.p) annotation (
      Line(points={{-14.6,-74},{6,-74},{6,-72},{4,-72}},          color = {0, 0, 255}));
    connect(B650.p, R650_632.p) annotation (
      Line(points={{4,-72},{23,-72}},                                                                         color = {0, 0, 255}));
    connect(R650_632.n, B632.p) annotation (
      Line(points={{41,-72},{62,-72}},                                                  color = {0, 0, 255}));
    ...
    connect(B632.p, Load02.p)
      annotation (Line(points={{62,-72},{86,-72}}, color={0,0,255}));
    connect(B11.p, Load11.p) annotation (Line(points={{22,140},{24,140},{24,120},
          {22,120}}, color={0,0,255}));
    connect(B2.p, twoWindingTransformer1.p) annotation (Line(points={{-54,-28},{
          -54,-74},{-45.4,-74}}, color={0,0,255}));
    annotation (
