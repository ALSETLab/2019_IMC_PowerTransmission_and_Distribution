...
model IEEE14_ThreePh_UnBal_B02
  extends Modelica.Icons.Example;
    ...
    ThreePhase.Branches.Lines.Line_3Ph R650_632(
      ...
      Placement(visible = true, transformation(origin={50,-76},    extent = {{-14, -10}, {14, 10}}, rotation = 0)));
...
equation
    ...
    connect(B2.p, Substation.p) annotation (Line(points={{-54,-28},{-50,-28},{-50,
          -76},{-27,-76}}, color={0,0,255}));
  connect(Substation.A, Bus650.p1)
    annotation (Line(points={{-5,-67},{12,-67},{12,-67}}, color={0,0,255}));
  connect(Substation.B, Bus650.p2)
    annotation (Line(points={{-5,-76},{12,-76}}, color={0,0,255}));
  connect(Substation.C, Bus650.p3)
    annotation (Line(points={{-5,-85},{12,-85},{12,-85}}, color={0,0,255}));
  connect(Bus650.p1, R650_632.Ain) annotation (Line(points={{12,-67},{16,-67},{
          16,-66},{37,-66},{37,-67}}, color={0,0,255}));
  connect(Bus650.p2, R650_632.Bin) annotation (Line(points={{12,-76},{16,-76},{
          16,-74},{37,-74},{37,-76}}, color={0,0,255}));
  connect(Bus650.p3, R650_632.Cin) annotation (Line(points={{12,-85},{16,-85},{
          16,-85},{37,-85}}, color={0,0,255}));
  connect(R650_632.Aout, Bus632.p1) annotation (Line(points={{63,-67},{70,-67},
          {70,-67},{90,-67}}, color={0,0,255}));
  connect(R650_632.Bout, Bus632.p2)
    annotation (Line(points={{63,-76},{90,-76}}, color={0,0,255}));
  connect(R650_632.Cout, Bus632.p3) annotation (Line(points={{63,-85},{70,-85},
          {70,-85},{90,-85}}, color={0,0,255}));
  connect(Bus632.p1, Load2.A) annotation (Line(points={{90,-67},{94,-67},{94,
          -67.1},{113,-67.1}}, color={0,0,255}));
  connect(Bus632.p2, Load2.B)
    annotation (Line(points={{90,-76},{113,-76}}, color={0,0,255}));
  connect(Bus632.p3, Load2.C) annotation (Line(points={{90,-85},{94,-85},{94,
          -84.9},{113,-84.9}}, color={0,0,255}));
    annotation (
