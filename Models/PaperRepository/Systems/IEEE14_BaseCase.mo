...
model IEEE14_BaseCase
    ...
    OpenIPSL.Electrical.Branches.PwLine pwLinewithOpeningSending(B = 0.0374/2, G = 0, R = 0.05811, X = 0.17632, opening = 2, t1 = 1000, t2 = 1010) annotation (
      Placement(visible = true, transformation(extent = {{-2, -82}, {16, -69}}, rotation = 0)));
    ...
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load12(P_0 = lambda*6.1, Q_0 = lambda*1.6, V_0 = 0.931653, angle_0 = -24.1469) annotation (
      Placement(visible = true, transformation(origin = {-128, 94}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load13(P_0 = lambda*13.5, Q_0 = lambda*5.8, V_0 = 0.922189, angle_0 = -24.2433) annotation (
      Placement(visible = true, transformation(origin = {-64, 138}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load10(P_0 = lambda*9, Q_0 = lambda*5.8, V_0 = 0.907355, angle_0 = -23.8754) annotation (
      Placement(visible = true, transformation(origin = {16, 142}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load14(P_0 = lambda*14.9, Q_0 = lambda*5.0, V_0 = 0.886530, angle_0 = -25.7120) annotation (
      Placement(visible = true, transformation(origin = {104, 140}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load9(P_0 = lambda*29.5, Q_0 = lambda*16.6, V_0 = 0.911528, angle_0 = -23.5173) annotation (
      Placement(visible = true, transformation(origin = {86, 78}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load6(P_0 = lambda*11.2, Q_0 = lambda*7.5, V_0 = 0.957194, angle_0 = -22.6342) annotation (
      Placement(visible = true, transformation(origin = {-46, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load5(P_0 = lambda*7.6, Q_0 = lambda*1.6, V_0 = 0.938543, angle_0 = -13.0428) annotation (
      Placement(visible = true, transformation(origin = {-24, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load4(P_0 = lambda*47.8, Q_0 = lambda*4.0, V_0 = 0.926487, angle_0 = -15.4284) annotation (
      Placement(visible = true, transformation(origin = {64, -56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load3(P_0 = lambda*94.2, Q_0 = lambda*19, V_0 = 0.927523, angle_0 = -19.7550) annotation (
      Placement(visible = true, transformation(origin = {84, -106}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    OpenIPSL.Electrical.Loads.PSAT.VoltDependant Load2(P_0 = lambda*21.7, Q_0 = lambda*12.7, V_0 = 0.996624, angle_0 = -7.3620) annotation (
    ...
    OpenIPSL.Electrical.Branches.PSAT.TWTransformerWithFixedTapRatio tWTransformerWithFixedTapRatio4(R = 0, X = 0.17615, fn = 60, m = 1) annotation (
      Placement(visible = true, transformation(origin = {120, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    PaperRepository.GenGroups.GroupBus2 GenBus2(P_0 = 40.00, Q_0 = 50.00, V_0 = 0.996624, V_b = 69, angle_0 = -7.3620) annotation (
      Placement(visible = true, transformation(origin = {-86, -156}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    PaperRepository.GenGroups.GroupBus3 GenBus3(P_0 = 0.00, Q_0 = 40.00, V_0 = 0.927523, V_b = 69, angle_0 = -19.7550) annotation (
      Placement(visible = true, transformation(origin = {22, -140}, extent = {{-10, -10}, {12, 10}}, rotation = 0)));
    PaperRepository.GenGroups.GroupBus6 GenBus6(P_0 = 0.00, Q_0 = 24.00, V_0 = 0.957194, V_b = 13.8, angle_0 = -22.6342) annotation (
      Placement(visible = true, transformation(origin = {-76, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    PaperRepository.GenGroups.GroupBus8 GenBus8(P_0 = 0, Q_0 = 24.00, V_0 = 0.982409, V_b = 18, angle_0 = -20.6599) annotation (
      Placement(visible = true, transformation(origin = {184, -38}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    PaperRepository.GenGroups.GroupBus1 GenBus1(P_0 = 355.47447, Q_0 = 84.7841, V_0 = 1.06, V_b = 69, angle_0 = 0) annotation (
      Placement(visible = true, transformation(origin = {-156, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    PaperRepository.Loads.LoadVar Load11(P_0 = lambda*3.644, Q_0 = lambda*2.107, V_0 = 0.925783, angle_0 = -23.4678, dP = 0.15, dQ = 0.15)  annotation (
      Placement(visible = true, transformation(origin = {16, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(B11.p, Load11.p) annotation (
      Line(points = {{16, 40}, {16, 40}, {16, 18}, {16, 18}}, color = {0, 0, 255}));
    connect(B4.p, pwLinewithOpeningSending.n) annotation (
      Line(points={{32,-32},{32,-76},{15.1,-76},{15.1,-75.5}},      color = {0, 0, 255}));
    connect(B2.p, pwLinewithOpeningSending.p) annotation (
      Line(points={{-60,-128},{-60,-106},{-14,-106},{-14,-76},{-1.1,-76},{-1.1,
            -75.5}},                                                                             color = {0, 0, 255}));
    ...
    connect(tWTransformerWithFixedTapRatio4.p, B7.p) annotation (
      Line(points={{109,-38},{92,-38},{92,1},{91,1}},          color = {0, 0, 255}));
    connect(tWTransformerWithFixedTapRatio4.n, B8.p) annotation (
      Line(points={{131,-38},{150,-38},{150,-37},{149,-37}},          color = {0, 0, 255}));
    connect(B9.p, tWTransformerWithFixedTapRatio3.n) annotation (
      Line(points={{86,44},{90,44},{90,31},{90,31}},          color = {0, 0, 255}));
    connect(B7.p, tWTransformerWithFixedTapRatio3.p) annotation (
      Line(points={{91,1},{90,1},{90,9},{90,9}},          color = {0, 0, 255}));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">You should have received a copy of the GNU Lesser General Public License along with the OpenIPSL. If not, see &LT;http://www.gnu.org/licenses/&GT;.</span></p>
      ...
      experiment(StopTime = 70, Interval = 0.005, Tolerance = 0.0002, StartTime = 0),
