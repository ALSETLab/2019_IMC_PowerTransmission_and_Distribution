...
model IEEE14_ThreePh_UnBal_B11
  ...
  ThreePhase.Branches.MonoTri.Transformer_MT Substation(Connection = 3, X = 0.55618, R = 0.00) annotation (
  ...
  ThreePhase.Buses.Bus_3Ph Bus632 annotation (
    Placement(visible = true, transformation(origin = {276, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ThreePhase.Branches.Lines.Line_3Ph R650_632(Bseraa = -2.0651, Bserab = 0.1869, Bserac = 0.1869, Bserbb = -2.0651, Bserbc = 0.1869, Bsercc = -2.0651, Gseraa = 2.1307, Gserab = -0.3584, Gserac = -0.3584, Gserbb = 2.1307, Gserbc = -0.3584, Gsercc = 2.1307) annotation (
    Placement(visible = true, transformation(origin = {236, 36}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  Loads.Load3PhVar Load13Nodes(AngA = 4.3794, AngB = -116.6206, AngC = 124.3794, P_a = lambda * 1.1667, P_b = lambda * 1.1667, P_c = lambda * 1.1667, Q_a = lambda * 0.6, Q_b = lambda * 0.6, Q_c = lambda * 0.6, VA = 0.892453, VB = 0.892453, VC = 0.892453, dP = [0.245, 0.0, 0.245], dQ = [0.126, 0.0, 0.126]) annotation (
    Placement(visible = true, transformation(origin = {310, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
equation
  ...
  connect(Bus632.p3, Load13Nodes.C) annotation (
    Line(points = {{276, 27}, {298, 27}, {298, 27.1}, {299, 27.1}}, color = {0, 0, 255}));
  connect(Bus632.p2, Load13Nodes.B) annotation (
    Line(points = {{276, 36}, {300, 36}, {300, 36}, {299, 36}}, color = {0, 0, 255}));
  connect(Bus632.p1, Load13Nodes.A) annotation (
    Line(points = {{276, 45}, {300, 45}, {300, 44.9}, {299, 44.9}}, color = {0, 0, 255}));
  connect(R650_632.Cout, Bus632.p3) annotation (
    Line(points = {{249, 27}, {276, 27}, {276, 27}, {276, 27}}, color = {0, 0, 255}));
  connect(R650_632.Bout, Bus632.p2) annotation (
    Line(points = {{249, 36}, {276, 36}, {276, 36}, {276, 36}}, color = {0, 0, 255}));
  connect(R650_632.Aout, Bus632.p1) annotation (
    Line(points = {{249, 45}, {276, 45}, {276, 45}, {276, 45}}, color = {0, 0, 255}));
  connect(Bus650.p3, R650_632.Cin) annotation (
    Line(points = {{198, 27}, {224, 27}, {224, 27}, {223, 27}}, color = {0, 0, 255}));
  connect(Bus650.p2, R650_632.Bin) annotation (
    Line(points = {{198, 36}, {224, 36}, {224, 36}, {223, 36}}, color = {0, 0, 255}));
  connect(Bus650.p1, R650_632.Ain) annotation (
    Line(points = {{198, 45}, {224, 45}, {224, 45}, {223, 45}}, color = {0, 0, 255}));
  connect(Substation.C, Bus650.p3) annotation (
    Line(points = {{181, 27}, {188, 27}, {188, 27}, {198, 27}}, color = {0, 0, 255}));
  connect(Substation.B, Bus650.p2) annotation (
    Line(points = {{181, 36}, {198, 36}}, color = {0, 0, 255}));
  connect(Substation.A, Bus650.p1) annotation (
    Line(points = {{181, 45}, {188, 45}, {188, 45}, {198, 45}}, color = {0, 0, 255}));
  connect(B11.p, Substation.p) annotation (
    Line(points = {{16, 40}, {16, 36}, {159, 36}}, color = {0, 0, 255}));
  annotation (
