...
model IEEE14_ThreePh_Bal_B11
  ...
  PaperRepository.Loads.Load3PhVar Load13Nodes(AngA = 4.3794, AngB = -116.6206, AngC = 124.3794, P_a = lambda * 1.1667, P_b = lambda * 1.1667, P_c = lambda * 1.1667, Q_a = lambda * 0.6, Q_b = lambda * 0.6, Q_c = lambda * 0.6, VA = 0.892453, VB = 0.892453, VC = 0.892453, dP = [0.16333, 0.16333, 0.16333], dQ = [0.084, 0.084, 0.084]) annotation (
...
equation
  connect(Bus632.p1, Load13Nodes.A) annotation (
    Line(points={{276,45},{288,45},{288,44.9},{299,44.9}},
                                          color = {0, 0, 255}));
  connect(Bus632.p2, Load13Nodes.B) annotation (
    Line(points = {{276, 36}, {299, 36}}, color = {0, 0, 255}));
  connect(Bus632.p3, Load13Nodes.C) annotation (
    Line(points={{276,27},{288,27},{288,27.1},{299,27.1}},
                                          color = {0, 0, 255}));
